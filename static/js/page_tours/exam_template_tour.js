    ...
    var steps = [
      ...
      },
      {
        ...
        popover: {
          ...
          description: 'Estos datos (más docente y cátedra, opcionales) se pre-completan en cualquier examen que use esta plantilla. El botón "Nuevo" junto a cada campo permite cargar uno sin salir de esta pantalla.',
          side: 'top',
        },
      },
      {

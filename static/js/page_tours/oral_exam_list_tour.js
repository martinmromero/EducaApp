...
(function () {
  function buildSteps() {
    var steps = [
      ...
      {
        element: '#oralWizardBtn',
        popover: {
          title: 'Asistente',
          description: 'La misma información, pero pedida un paso a la vez — útil para armar el primer cuestionario o cuando conviene ir de a poco.',
          side: 'bottom',
        },
      },
      {

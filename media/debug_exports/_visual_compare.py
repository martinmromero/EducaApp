...
if not pdftoppm.exists():
    raise RuntimeError(f'pdftoppm not found: {pdftoppm}')

pairs = [
    ('test_single_export.docx', 'test_single_export.pdf', 'cmp_single'),
    ('test_batch_export.docx', 'test_batch_export.pdf', 'cmp_batch'),
]
...
report_path = out / 'visual_compare_report.txt'

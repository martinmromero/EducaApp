# Generated by Django 4.2.20 on 2025-08-03 23:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.PositiveIntegerField(default=2025, verbose_name='Año académico')),
                ('exam_type', models.CharField(blank=True, choices=[('1er_parcial', '1er. Parcial'), ('2do_parcial', '2do. Parcial'), ('3er_parcial', '3er. Parcial'), ('final', 'Final'), ('recuperatorio', 'Recuperatorio'), ('practico', 'Práctico')], default=None, max_length=20, null=True, verbose_name='Tipo de examen')),
                ('exam_mode', models.CharField(blank=True, choices=[('presencial', 'Presencial'), ('virtual', 'Virtual'), ('domiciliario', 'Domiciliario'), ('hibrido', 'Híbrido'), ('otro', 'Otro')], default=None, max_length=20, null=True, verbose_name='Modalidad de examen')),
                ('shift', models.CharField(blank=True, choices=[('manana', 'Mañana'), ('tarde', 'Tarde'), ('noche', 'Noche')], max_length=20, null=True, verbose_name='Turno')),
                ('resolution_time', models.CharField(blank=True, default=None, help_text='Ej: 90 minutos, 2 horas', max_length=50, null=True, verbose_name='Duración del examen')),
                ('topics_to_evaluate', models.TextField(blank=True, help_text='Listado de temas incluidos en el examen', verbose_name='Temas a evaluar')),
                ('notes_and_recommendations', models.TextField(blank=True, verbose_name='Notas y recomendaciones')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Última actualización')),
                ('is_active', models.BooleanField(default=True, verbose_name='Activo')),
                ('institution_logo', models.ImageField(blank=True, null=True, upload_to='exam_templates/logos/', verbose_name='Logo institucional')),
                ('custom_css', models.TextField(blank=True, help_text='CSS personalizado para la plantilla', verbose_name='Estilos CSS')),
            ],
            options={
                'verbose_name': 'Plantilla de examen',
                'verbose_name_plural': 'Plantillas de examen',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('learning_outcomes', models.TextField(blank=True, help_text='Legacy field - almacena outcomes en texto o JSON', null=True)),
                ('careers', models.ManyToManyField(related_name='subject_careers', to='material.career')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField(help_text='Texto completo del resultado de aprendizaje', verbose_name='Contenido')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='learning_outcome_relations', to='material.subject', verbose_name='Materia')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='career',
            name='campus',
            field=models.ManyToManyField(blank=True, related_name='career_campuses', to='material.campusv2', verbose_name='Campus'),
        ),
        migrations.AddField(
            model_name='career',
            name='faculties',
            field=models.ManyToManyField(blank=True, related_name='career_faculties', to='material.facultyv2', verbose_name='Facultades'),
        ),
        migrations.AddField(
            model_name='career',
            name='subjects',
            field=models.ManyToManyField(blank=True, related_name='career_subjects', to='material.subject', verbose_name='Materias'),
        ),
        migrations.AddField(
            model_name='campusv2',
            name='institution',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject', 'created_at'], name='material_le_subject_906745_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='institutionsubject',
        ...
        migrations.AddIndex(
            model_name='career',
            index=models.Index(fields=['name'], name='material_ca_name_50eca8_idx'),
        ),
        migrations.AddConstraint(
            model_name='campusv2',

# Generated by Django 4.2.20 on 2025-05-01 01:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True)),
                ('logo', models.ImageField(blank=True, null=True, upload_to='institution_logos_v2/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='faculties', to='material.institutionv2')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField(blank=True)),
                ('is_active', models.BooleanField(default=True)),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='campuses', to='material.institutionv2')),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('name', 'institution'), name='unique_facultyv2_per_institution'),
        ),
        migrations.AddConstraint(
            model_name='faculty',
        ...
        migrations.AddConstraint(
            model_name='campusv2',
            constraint=models.UniqueConstraint(fields=('name', 'institution'), name='unique_campusv2_per_institution'),
        ),
        migrations.AddConstraint(
            model_name='campus',

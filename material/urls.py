...
urlpatterns = [
    ...
    path('create-exam-template/asistente/', material_views.create_exam_template_wizard, name='create_exam_template_wizard'),
    ...
    path('formatos-impresion/<int:pk>/editar/', material_views.formato_impresion_edit, name='formato_impresion_edit'),
    ...
    path('examenes/lotes/<int:batch_id>/exportar/docx/', export_views.exportar_lote_docx, name='exportar_lote_docx'),
    path('examenes/lotes/<int:batch_id>/exportar/pdf/', export_views.exportar_lote_pdf, name='exportar_lote_pdf'),
    path('examenes/versiones/available-questions/', material_views.exam_version_available_questions, name='exam_version_available_questions'),
    path('examenes/versiones/replace-question/', material_views.replace_exam_version_question, name='replace_exam_version_question'),
...
# instituciones v2
    ...
    path('instituciones-v2/crear/asistente/', material_views.create_institution_v2_wizard, name='create_institution_v2_wizard'),
...
path('oral-exams/asistente/', material_views.create_oral_exam_wizard, name='create_oral_exam_wizard'),
...
path('oral-exams/exchange-question/', material_views.exchange_question, name='exchange_question'),
    ...
    path('comenzar/demo/actualizar-seleccion/', material_views.onboarding_v2_demo_update_selection, name='onboarding_v2_demo_update_selection'),
    ...
    path('grupos/<int:pk>/salir/', material_views.grupo_salir, name='grupo_salir'),
    path('grupos/<int:pk>/remover/<int:user_id>/', material_views.grupo_remover_miembro, name='grupo_remover_miembro'),
